...
public class View3DUIController : MonoBehaviour
{
    ...
    private View3DInputController inputController;
    ...
    private void Awake()
    {
        ...
        inputController = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<View3DInputController>();
